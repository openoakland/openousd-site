          ...
          >
            <Nav.Item>
              <Link to="/" activeClassName="active">
                ...
                <FormattedMessage id="navigation.index" />
              </Link>
            </Nav.Item>
            <Nav.Item>
              <Link to="/central-programs/" activeClassName="active">
                <span className="d-none d-md-block">
                  <span className="dot" />
                </span>
                <FormattedMessage id="navigation.central-programs" />
              </Link>
            </Nav.Item>
            <Nav.Item>
            ...
            <Nav.Item>
              <Link to="/whats-new/" activeClassName="active">
                <span className="d-none d-md-block">
                  <span className="dot" />
                </span>
                What's New
